# Bootcamp Rocketseat: Desafio NodeJS 1
...
```
git clone https://github.com/marcionicolau/bootcamp-nodejs-desafio1
```
...
yarn start
```
Abrir o navegador no endereço __http://localhost:3000__
